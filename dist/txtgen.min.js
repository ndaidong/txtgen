...
f=function(a){for(var b;!b;)b=a[Math.floor(Math.random()*(a.length-1-0+1))+0];return b},h=function(a){var b="a";a.match(/^(a|e|i|o)/)&&(b="an");return b+" "+a},p=["noun","a_noun","nouns","adjective","an_adjective"],q={noun:function(){return f(e)},a_noun:function(){return h(f(e))},nouns:function(){var a;a=f(e);a.endsWith("s")||(a.match(/(ss|ish|ch|x|us)$/)?a+="e":a.endsWith("y")&&!c.includes(a.charAt(a.length-2))&&(a=a.slice(0,a.length-1),a+="ie"),a+="s");return a},adjective:function(){return f(d)},
an_adjective:function(){return h(f(d))}},k=function(){var a;a=.33>Math.random()?f(n):"";var b=f(m),g=b;if((b=b.match(/\{\{(.+?)\}\}/g))&&b.length)for(var c=0;c<b.length;c++){var d=b[c].replace("{{","").replace("}}","").replace(/^[\s\xa0]+|[\s\xa0]+$/g,"").replace(/\r?\n|\r/g," ").replace(/\s\s+|\r/g," "),e=void 0;p.includes(d)&&(e=q[d]());g=g.replace(b[c],e)}return a+g},l=function(a){(a=void 0===a?0:a)||(a=Math.floor(8*Math.random())+3);a=Math.min(a,15);for(var b=[];b.length<a;){var c=k(),c=c.charAt(0).toUpperCase()+
c.slice(1),d;d=f(".......!?!?;...".split(""));c+=d;b.push(c)}return b.join(" ")};return{sentence:k,phrase:l,article:function(a){(a=void 0===a?0:a)||(a=Math.floor(8*Math.random())+3);a=Math.min(a,15);for(var b=[];b.length<a;){var c=l();b.push(c)}return b.join("\n\n")}}});