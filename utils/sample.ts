...
export const addNouns = (ls: string[] = []): number => {
  nouns = mergeArray(nouns, ls);
  return nouns.length;
};

export const addAdjectives = (ls: string[] = []): number => {
  adjectives = mergeArray(adjectives, ls);
  return adjectives.length;
};

export const addTemplates = (ls: string[] = []): number => {
  sentenceTemplates = mergeArray(sentenceTemplates, ls);
  return sentenceTemplates.length;
};

export const setNouns = (ls: string[]): number => {
  nouns = [...new Set([...ls])];
  return nouns.length;
};

export const setAdjectives = (ls: string[] = []): number => {
  adjectives = [...new Set([...ls])];
  return adjectives.length;
};

export const setTemplates = (ls: string[] = []): number => {
